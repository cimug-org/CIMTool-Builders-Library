...
| [json-schema-draft-07.xsl](shipped-builders/json-schema-draft-07-xsl/builder.md) | JSON schema | The **json-schema-draft-07.xsl** builder generates a standalone HTML file containing the complete documentation for all classes, attributes and associations defined in a profile. |
| [json-schema-draft-2020-12.xsl](shipped-builders/json-schema-draft-2020-12-xsl/builder.md) | JSON schema | The **json-schema-draft-2020-12.xsl** builder generates a standalone HTML file containing the complete documentation for all classes, attributes and associations defined in a profile. |
