...
This is the official UCAI CIMug repository of custom **CIMTool** XSLT transform builders and is provided as a public space for the CIM community to create, collaborate and ultimately contribute back XSLT builders for the benefit of the CIMTool community at large.  This "library" of builders can be used in **CIMTool** to generate various types of target artifact from a CIMTool profile definition.  
