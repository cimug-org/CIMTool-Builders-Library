...
| [cimantic-graphs-init.xsl](custom-builders/cimantic-graphs/builder.md)| Python Source Code | This builder is intended to be used in conjunction the **cimantic-graphs-init.xsl** builder, which generates the `python __init__.py` file required for library imports to work correctly. |
