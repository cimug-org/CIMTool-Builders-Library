...
| [html.xsl](shipped-builders/html-xsl/builder.md) | HTML file | The **html.xsl** builder generates a standalone HTML file (```*.html```) containing the complete documentation for all classes, attributes and associations defined in a profile. |
