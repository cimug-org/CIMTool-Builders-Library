...
1. The detailed description in your ```builder.md``` has been completed.  If there are particular aspects of your builder that should be highlighted this should be done here. For example, if your builder warrants it, you may include images in your builder's folder and include links to them in your description.  A great example of this is The [profile-doc-rtf.xsl](shipped-builders/profile-doc-rtf/profile-doc-rtf.xsl) builder.
