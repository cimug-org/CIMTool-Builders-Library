...
| [apache-avro-schema.xsl](shipped-builders/apache-avro-schema/builder.md) | Apache Avro schema | The **[apache-avro-schema.xsl](shipped-builders/apache-avro-schema/builder.md)** builder generates an [Apache Avro](https://avro.apache.org/) schema file (`*.avsc`) defining the record types and fields corresponding to the classes and attributes in a profile. The generated schema can be used with the Apache Avro serialization framework for compact, efficient data exchange between systems. |
