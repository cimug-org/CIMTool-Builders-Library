...
| [sql.xsl](shipped-builders/sql/builder.md) | SQL DDL file | The **[sql.xsl](shipped-builders/sql/builder.md)** builder generates an ANSI SQL-compliant DDL (Data Definition Language) script (`*.sql`) that can be used to create the database tables and fields corresponding to the classes and attributes represented in a profile. > ⚠️ **Deprecated as of CIMTool 2.3.0.** Migrate to **[sql-rdfs-ansi92.xsl](shipped-builders/sql-rdfs-ansi92/builder.md)**. |
