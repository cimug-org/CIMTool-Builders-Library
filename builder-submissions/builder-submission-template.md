...
{REPLACE THE PLACEHOLDER VALUES IN THE TABLE BELOW WITH THE RECOMMENDED NTE SETTINGS FOR YOUR CUSTOM BUILDER. THE XSLT NAME IS THE FILENAME OF YOUR .XSL FILE. THE INCLUDES FILE NAME IS THE NAME OF ANY XSLT INCLUDE FILE REQUIRED BY YOUR BUILDER, OR LEAVE THE CELL BLANK IF NONE IS NEEDED. THE TYPE IS ONE OF: XSD, TEXT, OR TRANSFORM. THE EXTENSION IS THE FILE EXTENSION THAT WILL BE APPLIED TO ARTIFACTS GENERATED BY YOUR BUILDER AND MUST BE UNIQUE ACROSS ALL BUILDERS IN THE LIBRARY.}
...
| Field | Value |
|---|---|
| Builder XSLT Name: | `{your-builder-name.xsl}` |
| Includes File Name: | {name-of-include-file.xsl if applicable, otherwise leave blank} |
| Transform Builder Type: | `{TEXT \| XSD \| TRANSFORM}` |
| File Extension of Generated Files: | `{your-extension}` |
