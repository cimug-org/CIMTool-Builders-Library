...
The **[json-schema-draft-07-jsonschema2pojo.xsl](json-schema-draft-07-jsonschema2pojo.xsl)** builder generates a JSON schema compliant with the draft **IEC 62361-104** standard (CIM Profiles to JSON schema Mapping). The version of the JSON schema specification that the schema conforms to is [draft-07](https://json-schema.org/draft-07/json-schema-release-notes.html).
...
```JSON
{
     ...
     "type": "object",
     "javaType": "org.ucaiug.substations.Dependency",
