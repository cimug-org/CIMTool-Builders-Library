...
The recommended best practice is to rename the builder file  (from ```plantuml--rdfs-l2r.xsl``` to ```custom-plantuml-rdfs-l2r.xsl``` for example) before importing. On import this will be interpreted as a new builder and you will be allowed to enter values in the Type and Extension fields.
