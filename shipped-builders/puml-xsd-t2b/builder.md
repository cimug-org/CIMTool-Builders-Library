...
The **[puml-xsd-t2b.xsl](puml-xsd-t2b.xsl)** builder produces a [PlantUML](https://plantuml.com) class diagram (`*.xsd-t2b.puml`) representing the profile for an XSD schema that this builder is executed on. The layout of the diagram is top-to-bottom (i.e. t2b).

This builder is the XSD schema companion to the **[puml-rdfs-t2b.xsl](../puml-rdfs-t2b/builder.md)** and **[puml-json-t2b.xsl](../puml-json-t2b/builder.md)** builders. For a left-to-right layout see the **[puml-xsd-l2r.xsl](../puml-xsd-l2r/builder.md)** builder.

The following is an example of a generated PlantUML class diagram:

![image](sample-puml-xsd-t2b.png)
...
| Field | Value |
|---|---|
| Builder XSLT Name: | `puml-xsd-t2b.xsl` |
| Includes File Name: |  |
| Transform Builder Type: | `TEXT` |
| File Extension of Generated Files: | `xsd-t2b.puml` |
