...
Again, refer to the [xsd.xsl](../xsd/builder.md) builder for generating XSD schemas compatible with the older [IEC 61968-100:2013 "Implementation Profiles" Ed 1.0](https://webstore.iec.ch/publication/6198).
...
| Field | Value |
|---|---|
| Builder XSLT Name: | `xsd-part100-ed2.xsl` |
| Includes File Name: |  |
| Transform Builder Type: | `XSD` |
| File Extension of Generated Files: | `part100-ed2.xsd` |
